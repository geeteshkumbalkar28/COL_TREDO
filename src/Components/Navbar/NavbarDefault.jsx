...
//   return (
//     <Navbar className="mx-auto max-w-screen-sm px-4 py-2 mt-4">
//       <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
//         <Typography
//           as="a"
//           href="#"
//           className="mr-4 cursor-pointer py-2 font-medium text-center"
//         >
//           Parity
//         </Typography>
...
export function NavbarDefault() {
  return (
    <div className="flex justify-center sm:mt-2">
      <div className="font-bold text-xl sm:text-lg w-full max-w-xs sm:max-w-sm text-center bg-gradient-to-r from-indigo-500 to-indigo-100 hover:from-indigo-600 hover:to-indigo-200 p-3 sm:p-4 rounded-xl">
        Parity
      </div>
    </div>
  );
