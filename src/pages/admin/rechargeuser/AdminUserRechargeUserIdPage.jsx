...
const AdminUserRechargeUserIdPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 mt-16 p-8  max-w-sm mx-auto transition-all duration-500">
      ...
      <div className="flex justify-between w-full gap-4">
        <ButtonUI
          onClick={() => navigate(-1)}
          className="flex items-center justify-center w-1/2 py-3 text-lg bg-gray-500 hover:bg-gray-600 text-white transition duration-300 rounded-lg shadow-lg"
        >
        ...
        {!isVerified && (
          <ButtonUI
            ...
            className="flex items-center justify-center w-1/2 py-3 text-lg bg-indigo-600 hover:bg-indigo-700 text-white transition duration-300 rounded-lg shadow-lg"
          >
        ...
        {isVerified && (
          <ButtonUI
            onClick={() =>
              navigate("/admin/user/1/name/amount", {
                state: {
                  userId,
                  name: userData.name,
...
export default AdminUserRechargeUserIdPage;
